...
#define __GMP_CC "arm-poky-linux-gnueabi-gcc  -mthumb -mfpu=neon-vfpv4 -mfloat-abi=hard -mcpu=cortex-a7 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer  -O2 -pipe -g -feliminate-unused-debug-types "
